 ...
 * @description C/C++ safe/security-context string literals should have sanitizer, validation, bounds, or clamp evidence in the same function.
 * @kind problem
...
select literal,
  "This C/C++ string literal makes a safety claim in a trust-sensitive context without recognized sanitizer or bounds evidence. claim_class=safe missing_evidence=no_bounds_or_sanitizer_guard."
