 ...
 * @description Java or Kotlin safe/security-context claims should have sanitizer, coercion, validation, or bounds evidence in the same callable.
 * @kind problem
...
select callable,
  "This Java/Kotlin callable name makes a safety claim in a trust-sensitive context without recognized sanitizer or bounds evidence. claim_class=safe missing_evidence=no_bounds_or_sanitizer_guard."
