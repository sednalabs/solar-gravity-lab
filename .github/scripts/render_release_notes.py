...
AREA_RULES: tuple[tuple[str, str], ...] = (
    ...
    ("render/android-vulkan/src/main/cpp", "Native Vulkan renderer"),
    ("render/android-vulkan/src/main/kotlin", "Android renderer host"),
    ("render/android-vulkan", "Android Vulkan renderer"),
