...
EXPECTED_MATRIX_ROWS = {
    ...
    "c-cpp": ("none", "./.github/codeql/codeql-cpp-claim-enforcement.yml"),
    "java-kotlin": ("manual", "./.github/codeql/codeql-java-kotlin-claim-enforcement.yml"),
    "python": ("none", "./.github/codeql/codeql-python-security.yml"),
    "rust": ("none", "./.github/codeql/codeql-rust-claim-enforcement.yml"),
}
